require(['jquery'], function ($)
{
	...
	tabItems = jQuery('<table class="tabs-items-wrapper"><tbody class="tabs-items" /></table>');
	...
	jQuery(document).on('click', '.section-config .tab-title', function(){
		...
		// jQuery(this).parents('tbody').next('tbody').find('tr').removeClass('show');
		// jQuery(this).parents('tbody').next('tbody').find('tr[data-tab-item-content="'+index+'"]').addClass('show');
