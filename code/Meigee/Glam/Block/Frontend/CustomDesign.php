<?php
namespace Meigee\Glam\Block\Frontend;
...
class CustomDesign extends \Magento\Framework\View\Element\Template
{
	...
	public function includeCss($storeId) {
		...
		$def_conf = 'glam_theme_design';
		$configs = array('', '_yellow', '_yellow_2', '_olivia', '_olivia_blue', '_olivia_orange', '_sophia', '_sophia_yellow', '_sophia_blue', '_ava', '_ava_green', '_ava_blue', '_isabella', '_isabella_orange', '_isabella_blue', '_mia', '_mia_blue', '_mia_yellow', '_abigail', '_abigail_red', '_abigail_yellow', '_emily', '_emily_red', '_emily_yellow', '_charlotte', '_charlotte_red', '_charlotte_yellow', '_harper', '_harper_yellow', '_harper_blue');
	...
	public function saveOpt($param = false, $sectionId) {
		if($param == true) {
			...
			$model = $objectManager->create('\Meigee\Glam\Model\cssGenerate');
