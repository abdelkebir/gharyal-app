...
class CheckboxSwitchHeader extends \Magento\Config\Block\System\Config\Form\Field
{
	...
	return '<style>
		#glam_general_glam_skins tr:not(#row_glam_general_glam_skins_site_skin) {display: none;}
		#glam_general_glam_skins tr:not(#row_glam_general_glam_skins_site_skin) .onoffswitch-label {display: none;}
	</style>';
    }
...
<script type="text/javascript">//<![CDATA[
		require(["jquery"], function(jQuery)
		{
			...
			{
				function UncheckAll(){
					var w = jQuery("#glam_general_glam_skins tr:not(#row_glam_general_glam_skins_site_skin)").find(".use-default .checkbox:checked");
				...
				UncheckAll();
				/* default_checkbox = jQuery("#glam_general_glam_skins tr:not(#row_glam_general_glam_skins_site_skin)").find(".use-default .checkbox");
				setTimeout(function(){
					default_checkbox.trigger("click");
				}, 1000); */
				setTimeout(function(){
					currentName = jQuery("#row_glam_general_glam_skins_site_skin .meigee-thumb-radio .meigee-thumb-horizontal > label.active input").attr("value");
					currentName = currentName.slice(0, -4);
					jQuery("#glam_general_glam_skins tr:not(#row_glam_general_glam_skins_site_skin)").each(function(){
				...
				jQuery("#row_glam_general_glam_skins_site_skin .meigee-thumb-radio .meigee-thumb-horizontal").on("click", function()
				{
					// jQuery("#glam_general_glam_skins tr#row_glam_general_glam_skins_skinheader_fashion2").find("input.checkbox").trigger("click");
...
//]]></script>';
    ...
    {
		$curr_skin_option = $this->_scopeConfig->getValue('glam_general/glam_skins', \Magento\Store\Model\ScopeInterface::SCOPE_STORE );
