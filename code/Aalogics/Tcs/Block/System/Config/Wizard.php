 ...
 */
namespace Aalogics\Tcs\Block\System\Config;

/**
 * Synchronize button renderer
 */
class Wizard extends \Magento\Config\Block\System\Config\Form\Field
{
    /**
     * @var string
     */
    protected $_template = 'Aalogics_Lcs::system/config/wizard.phtml';
    ...
    {
        return $this->getUrl('*/system_config_system_sync');
    }
