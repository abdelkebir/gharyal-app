...
namespace Amasty\InstagramFeed\Plugin\View\Page\Config;
...
class Renderer
{
    public const CACHE_KEY = 'Amasty_InstagramFeed_should_load_css_file';
    ...
    public function beforeRenderAssets(
        ...
        if ($shouldLoad) {
            $this->config->addPageAsset('Amasty_InstagramFeed::css/source/mkcss/aminstafeed.css');
        }
