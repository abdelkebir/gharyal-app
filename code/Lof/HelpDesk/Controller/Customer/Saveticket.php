...
class Saveticket extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $customerObj = $objectManager->create('Magento\Customer\Model\Customer')->load('email', $data['email']);
            $data['customer_id'] = $customerObj->getCollection()->getFirstItem()->getData('entity_id');
